...
import HeaderComponent from '@/components/HeaderAdminComponent.vue'
...
describe('HeaderAdminComponent', () => {
  it('whether it shows logo and "Map"-link', () => {
    ...
    expect(wrapper.find('a[href="/map"]').text()).toContain('Kart')
  })
  ...
  it('whether it calls logOutUser when logout is clicked', async () => {
    const wrapper = mount(HeaderComponent, {
      global: { plugins: [router] }
    })
